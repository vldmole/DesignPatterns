...
public class ApplicationView1 
{
	...
	//-----------------------------------------------------------------------------------------
	static public 
	ApplicationView1 create(List<Map.Entry<String, String>> sequenceOptionsList)
	{
		final ApplicationView1 appView = create();
		
		JScrollPane pane = createSequenceGeneratorsOptionList(appView, sequenceOptionsList);
	...
	//-----------------------------------------------------------------------------------------
	static public 
	ApplicationView1 create()
	{
		final ApplicationView1 appView = new ApplicationView1();
	...
	//----------------------------------------------------------------------------------------
	static
	JScrollPane createSequenceGeneratorsOptionList(ApplicationView1 appview, 
	...
	//-----------------------------------------------------------------------------------------
	static
	JFrame createFrame(final ApplicationView1 appView)
	{
	...
	//-----------------------------------------------------------------------------------------
	static
	JPanel createSouthPanel(final ApplicationView1 appView)
	{
